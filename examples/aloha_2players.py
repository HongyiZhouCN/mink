...
if __name__ == "__main__":
    ...
    tasks = [
        ...
        player2_l_ee_task := mink.FrameTask(
            frame_name="player2_left/gripper",
            frame_type="site",
            position_cost=1.0,
            orientation_cost=1.0,
            lm_damping=1.0,
        ),
        player2_r_ee_task := mink.FrameTask(
            frame_name="player2_right/gripper",
            frame_type="site",
            position_cost=1.0,
            orientation_cost=1.0,
            lm_damping=1.0,
    ...
    collision_pairs = [
        ...
        (player2_l_wrist_geoms, player2_r_wrist_geoms),
        (player2_l_geoms + player2_r_geoms, player2_frame_geoms + ["table_2"]),
    ]
